 ...
 *  Edited on: Jun 15, 2017
 *
 *  Copyright (c) 2016 Simon Gustafsson (www.optisimon.com), 2017 Tibor Vavra
...
public:
	...
	FT5426(int adapter_nr, int addr = 0x38, bool verbose = false) : _fd(0), _testMode(false), _verbose(verbose)
    {
		char fname[20];
